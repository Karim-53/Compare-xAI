...
for metric in metrics:
    ...
    fig.legend(lines + lines2, [explainer_mappings[a] for a in labels + labels2], frameon=True, shadow=True,
               loc="lower center", bbox_to_anchor=(0.43, 0), ncol=len(explainers), fontsize=14)
    plt.show()
