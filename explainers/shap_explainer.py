...
class Permutation(Explainer):
    ...
    def __init__(self, predict_func, df_reference, **kwargs):
        super().__init__()

        # use an independent masker
        masker = shap_lib.maskers.Independent(df_reference)
    ...
    def explain(self, dataset_to_explain, **kwargs):
        attribution: shap._explanation.Explanation = self.explainer(dataset_to_explain)
        # self.expected_values = shap_values.base_values
