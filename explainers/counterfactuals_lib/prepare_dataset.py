...
def create_dating_data():
    ...
    df = pd.read_csv(r"Bachelor-Bench\code\datasets\Speed Dating Data.csv", encoding='cp1252')
    ...
    df.to_csv(r"Bachelor-Bench\code\datasets\dating_data_custom.csv", index=False)
